  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <header className="text-center">
        <h1 className="text-4xl font-bold mb-4">Office Of Kgosana Koketso Rakhudu</h1>
      ...
      <section className="text-left mt-12">
        <h2 className="text-2xl font-semibold mb-4">Overview of the Office of Kgosana Koketso Rakhudu</h2>
      ...
      <section className="text-center mt-12">
        <h2 className="text-2xl font-semibold mb-4">VisionPlan 2035</h2>
        <p className="text-gray-700 mb-6">
        ...
        <Link to="/vision-plan" className="text-blue-500 hover:underline">Learn more about VisionPlan 2035</Link>
      ...
      <section className="text-center mt-12">
        ...
        <Link to="/objectives" className="text-blue-500 hover:underline">View our Objectives</Link>
        <img src="/images/Communityengagement.jpeg" alt="Students initiative" className="w-full h-64 object-contain mb-8" />
      </section>

      <footer className="mt-16 text-center">
        <p className="text-gray-600">Contact us: <Link to="/contact" className="text-blue-500 hover:underline">Get in touch</Link></p>
      </footer>
    </div>
  );
}
