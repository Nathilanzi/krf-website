  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold">About the Office of Kgosana Koketso Rakhudu</h1>
      </header>
      ...
      <section className="text-left mt-8 text-gray-700">
        ...
        <img src="/images/Officeofkgosanateams.jpeg" alt="Relevant pic" className="w-full h-64 object-contain mb-8"/>
        <p className="mb-6">
        ...
        <ul className="list-disc list-inside mb-6">
          <li><strong>Fostering Community Engagement:</strong> The Office regularly organizes community forums and Kgotla (traditional meetings) to ensure that every community member's voice is heard, fostering a governance system that is inclusive and participatory.</li>
          <li><strong>Building Strategic Partnerships:</strong> By aligning with national and international partners, the Office works to bring investment opportunities to the community. These partnerships are centered on sustainable development, respecting the cultural heritage of the region while promoting economic growth.</li>
          <li><strong>Preserving Culture and Identity:</strong> At its core, the Office is dedicated to preserving the community’s unique cultural identity. Through various initiatives like festivals, traditional arts programs, and heritage conservation projects, the Office ensures that the past is remembered while creating a vibrant cultural future.</li>
        </ul>
        <p className="mb-6">
