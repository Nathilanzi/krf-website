        ...
        {isVideoOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full relative">
              ...
              <video src="/videos/KgosanaRakhuduSOKA.mp4" alt= "Introduction video of the State of The Kgotla Adress" loading= "lazy" controls className="w-full h-auto rounded-md" />
            </div>
          </div>
        )}
      </section>
